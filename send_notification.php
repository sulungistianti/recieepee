<?php include("includes/header.php");
  ...
  $data_qry="SELECT * FROM tbl_recipe ORDER BY id DESC";
  ...
  if(isset($_POST['submit']))
  {
    ...
    {   
        ...
        $fields = array(
                        ...
                        'data' => array("foo" => "bar","recipe_id"=>$_POST['recipe_id'],"external_link"=>$external_link),
            ...
            <form action="" name="addeditcategory" method="post" class="form form-horizontal" enctype="multipart/form-data">
              ...
              <div class="section">
                <div class="section-body">
                  ...
                  <div class="form-group">
                    <label class="col-md-4 control-label">Recipe :-<br/>(Optional)
                    <p class="control-label-help">To directly open single recipe when click on notification</p></label>
                    <div class="col-md-8">
                      <select name="recipe_id" id="recipe_id" class="select2" required>
                        <option value="0">--Select Recipe--</option>
                        <?php
                            while($data_row=mysqli_fetch_array($data_result))
                            {
                        ?>                       
                        <option value="<?php echo $data_row['id'];?>"><?php echo $data_row['recipe_name'];?></option>                           
                        <?php
                          }
                        ?>
                      </select>
