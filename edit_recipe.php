<?php include("includes/header.php");
  ...
  //Get Category
   ...
   //Get Sub Category 
    $sub_cat_qry="SELECT * FROM tbl_sub_category WHERE cat_id='".$row['cat_id']."'";
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
 ...
 $(document).ready(function() {
    ...
    $.get('ajax_sub_cat.php?cat_id=' + $(this).val(), function(data) {
        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Edit Recipe</div>
            </div>
          </div>
